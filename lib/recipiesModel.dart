...
//
//     final recipiesModel = recipiesModelFromJson(jsonString);

import 'dart:convert';

RecipiesModel recipiesModelFromJson(String str) =>
    RecipiesModel.fromJson(json.decode(str));

String recipiesModelToJson(RecipiesModel data) => json.encode(data.toJson());
...
class RecipiesModel {
  ...
  factory RecipiesModel.fromJson(Map<String, dynamic> json) => RecipiesModel(
        recipes:
